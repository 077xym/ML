...
if __name__ == '__main__':
    X_train, y_train, X_test, y_test = load_data(samples=5000, train_test_ratio=0.7, rz=32)
    n_l = 500
    parameters = shallow_nn_model(X_train, y_train, n_l, runs=3000, learning_rate=1.2)
